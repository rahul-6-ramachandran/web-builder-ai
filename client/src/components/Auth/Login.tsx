...
export default function Login() {
  ...
  return (
    <>
      <div className="flex items-center mt-0 h-screen   ">
        <motion.div
        ...
        >
          <div
            ...
            style={{ backgroundImage: "url('images/4827591.jpg')" }}
          ></div>
        ...
        <a href="#" className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 hover:bg-gray-200 hover:text-black">
            ...
            <span className="w-5/6  py-3 font-bold text-center">Sign in with Google</span>
              ...
              <div className="mt-6 text-center justify-center flex items-center">
                {!loading ? (
                  <button
                    type="submit"
                    className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-200 hover:text-black focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
                  >
                    {" "}
                    Sign In{" "}
                  </button>
