...
export default function tailwindPlugin(editor: Editor) {
  ...
  editor.Components.addType("tailwind-button", {
    model: {
      ...
      init() {
        this.on(
          "change:content change:bgColor change:textColor change:size change:borderRadius",
          this.updateStyle
        );
      },
      ...
      updateStyle() {
        ...
        this.view?.el?.setAttribute(
          "onmouseover",
          `this.style.backgroundColor='${hoverBg}'; this.style.color='${hoverText}'`
        );
        this.view?.el?.setAttribute(
          "onmouseout",
          `this.style.backgroundColor='${bgColor}'; this.style.color='${textColor}'`
        );
      },
    },
    view: {
  ...
  editor.Components.addType("Container", {
    model: {
      ...
      init() {
        this.on(
          "change:width change:bgColor change:padding change:marginY change:marginX",
          this.updateStyle
        );
      },
